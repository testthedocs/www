...
# ttd build configuration file, created by
# `ablog start` on Tue Oct 30 13:20:59 2018.
#
...
blog_default_location = 'Amsterdam'
blog_default_author = 'Sven'
